...
import { BreachSimulatorClient } from '@/components/feature/breach-simulator/breach-simulator-client'
import { Lock, ArrowUpCircle } from 'lucide-react'
import { getOrgPlan, tierAtLeast } from '@/lib/plan'

export default async function BreachSimulatorPage() {
    ...
    const { data: userData } = await supabase
        .from('users')
        .select('department_id, organization_id, departments(breach_simulator_enabled)')
        .eq('id', user.id)
        .single()
            ...
            return (
                <div style={{ minHeight: '100vh', backgroundColor: '#0B0F19' }}
                    ...
                    <div className="max-w-md w-full text-center space-y-4 rounded-2xl border border-amber-500/30 bg-amber-500/5 p-10">
                        ...
                        <p className="text-slate-400">The Breach Response Simulator requires the <span className="text-amber-300 font-medium">Professional</span> plan or higher.</p>
                        <p className="text-slate-500 text-sm">
                            Contact{' '}
    ...
    const dept = Array.isArray(deptRaw) ? deptRaw[0] : deptRaw as { breach_simulator_enabled: boolean } | null
    const isLocked = dept !== null && dept !== undefined && dept.breach_simulator_enabled === false
    ...
    return (
        <div style={{
            ...
            backgroundImage: `
                ...
                radial-gradient(at 50% 100%, rgba(59,130,246,0.08) 0, transparent 50%)
            `,
            ...
            <div style={{
                ...
                <div className="text-center">
                    <div className="font-semibold text-white text-sm">Breach Response Simulator</div>
                    <div className="text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>
                        Data Breach Notification Decision Trainer
                    </div>
                </div>
                <Link
                    href="/dashboard"
                    ...
                    <div className="flex flex-col items-center gap-6 max-w-md text-center">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">
                                The Breach Response Simulator is not available for your department. Please contact your administrator if you believe this is an error.
                            </p>
                        </div>
                        <Link
                            href="/dashboard"
